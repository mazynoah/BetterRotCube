...
Point *project(Point *point) {
    ...
    double final_screen_space_projection_x = (d_projection_distance_factor * projected_x_dot_product_result /
                                              projected_z_dot_product_result) + ((double) WIDTH / 2.0);
    double final_screen_space_projection_y = ((double) HEIGHT / 2.0) - (
                                                 d_projection_distance_factor * projected_y_dot_product_result /
                                                 projected_z_dot_product_result);

    return create_point(final_screen_space_projection_x, final_screen_space_projection_y,
                        projected_z_dot_product_result);
}
...
Point *rotate_point_x(Point *point, Point *origin, double alpha) {
    ...
    double y_multiplied_by_cosine_for_x_rotation =
            y_delta_from_origin_reference * precalculated_cosine_of_alpha_for_x_rotation;
    double z_multiplied_by_sine_for_x_rotation =
            z_delta_from_origin_reference * precalculated_sine_of_alpha_for_x_rotation;

    double y_multiplied_by_sine_for_x_rotation =
            y_delta_from_origin_reference * precalculated_sine_of_alpha_for_x_rotation;
    double z_multiplied_by_cosine_for_x_rotation =
            z_delta_from_origin_reference * precalculated_cosine_of_alpha_for_x_rotation;

    double newly_calculated_rotated_y_position_for_x_axis =
            y_multiplied_by_cosine_for_x_rotation - z_multiplied_by_sine_for_x_rotation;
    double newly_calculated_rotated_z_position_for_x_axis =
            y_multiplied_by_sine_for_x_rotation + z_multiplied_by_cosine_for_x_rotation;
